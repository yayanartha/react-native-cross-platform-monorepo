            ...
            if (forwardProps) {
              ...
              if (Array.isArray(next)) {
                if (Object.keys(rest).length) {
                  next = next.map(
                    (item2) => (0, import_react10.isValidElement)(item2) ? (0, import_react10.cloneElement)(item2, rest) : item2
                  );
                }
                if (space || separator) {
                  next = (0, import_core27.spacedChildren)({
                ...
                next = import_react10.default.isValidElement(next) ? import_react10.default.cloneElement(next, { key: next.key, ...forwardProps }) : next;
              }
            }
            return next;
          })
...
var require_Dialog = __commonJS({
  "../../node_modules/@tamagui/dialog/dist/cjs/Dialog.js"(exports, module2) {
    ...
    var DialogPortal2 = DialogPortalFrame2.extractable(
      (props) => {
...
var require_useCurrentColor = __commonJS({
  "../../node_modules/@tamagui/helpers-tamagui/dist/cjs/useCurrentColor.js"(exports, module2) {
    ...
    var useCurrentColor = /* @__PURE__ */ __name((colorProp) => {
      ...
      return (0, import_core27.variableToString)(
        theme[colorProp] || (0, import_core27.getTokens)(true).color[colorProp] || colorProp || theme.color
      );
    }, "useCurrentColor");
  }
});
